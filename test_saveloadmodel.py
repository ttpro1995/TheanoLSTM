...
def main():
    ...
    if (model_name=='lstm'):
        ...
        modelClass = LSTM
        model = util.load_model_parameters_theano('saved_model/LSTMSGD_first.npz', modelClass)
    ...
    util.save_model_parameters_theano(model, saveFolder, 'SGD_first_2')
    print 'breakpoint'
